    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      <div className="mb-6">
        ...
        <p className="mt-1 text-muted">
          Paste your resume or upload a TXT, PDF, JPG, or PNG file. We parse the
          skills you mention and cross-reference them against the gaps your
            ...
            {result.realityCheck.surplus.length > 0 && (
              <div className="surface-card p-5">
                ...
                <p className="mt-3 text-xs text-muted">
                  These are not wasted — they may matter for a different branch
                  or make you a stronger cross-functional candidate.
                </p>
              </div>
            )}
          </div>
