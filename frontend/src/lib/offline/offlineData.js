...
export const DEMO_STUDENT_PROFILE = {
  ...
  graduationYear: 2026,
  currentRole: "Intern — Full Stack / Backend Developer",
  experienceYears: 0.5,
  location: "Pune",
  targetRole: "Full Stack Engineer or Systems Architect",
  currency: "INR",
  skills: [
  ...
  interests: ["coding", "full-stack", "data", "problem solving", "systems"],
  constraints: {
