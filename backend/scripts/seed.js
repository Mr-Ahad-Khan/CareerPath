...
const AVATAR_COLORS = ['#ffb340', '#3ddc97', '#5dade2', '#e74c8b', '#9b7ed4', '#f4845f', '#5ab1bb', '#d4a017'];
...
const MENTORS = [
  {
    ...
    expertise: ['System Design', 'Distributed Systems', 'AWS', 'Kubernetes', 'Mentoring'],
  ...
  },
  {
    ...
    expertise: ['Leadership', 'Hiring', 'Stakeholder Management', 'OKRs', 'Strategy'],
  ...
  },
  {
    ...
    expertise: ['Product Strategy', 'User Research', 'A/B Testing', 'Stakeholder Management'],
  ...
  },
  {
    ...
    expertise: ['React', 'TypeScript', 'Performance', 'Accessibility', 'System Design'],
  ...
  },
  {
    ...
    expertise: ['SRE', 'Kubernetes', 'Observability', 'Go', 'Incident Response'],
